...
fun main() {
    ...
    /**     Uzerinde degisiklik yapamadigimiz (readOnly) siniflara, ya da yapmak istemedigimiz siniflara,
     *      bu siniflarin icerisinde yazmadan fonksiyon tanimlayabilmemizi saglar.
     *      Boylece o sinifa uye bir fonksiyon kazandirabiliriz.
     *      Bunu yaparken unutmamaniz gereken; yazdiginiz extension fonksiyon aslinda o sinifin gercek bir fonksiyonu olmayacaktir.
     *
     *      Receiver diye adlandiracagimiz bir sinifa ihtiyac duyar. Extension yazacagimiz sinifi ifader.
     *
     *      Yapisal olarak;
     *
    ...
    // extension fonksiyonlar direkt olarak value'lar uzerinden cagrilabilir.
    (3 + 0.14).log("")
    1341.log("")
    1341.toFloat()
    18608268888.log("")
    ...
    // isterseniz de degiskenler uzerinden cagrilabilir.
    pi.log("")
    schoolNumber.log("")
...
open class Shape {
    ...
    /**
     *      Bir sinifin icinde, farkli bir sinifa ait extension fonksiyon yazilirsa, bu sinifin icinde ayni isimde normal bir fonksiyon olsa bile,
     *      extension fonksiyonun icerisinde, ayni isme sahip fonksiyon cagrilirsa, bu extension fonksiyona isaret eder demektir.
     *      Sinifin ayni isimdeki uye fonksiyonunu extension fonksiyon icersinde cagirmak icin
 ...
 *      Companion object'lere de extension yazilabilir.
 * **/
